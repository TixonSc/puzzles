...
"""
Бармен має вибрати місце тільки першому інтроверту, так аби їх прийшло до його бару як найбільше.
Інтроверт обирає місце із найбільшою відстанню до найближчої людини із можливих.
Інтроверт не займає місце, якщо відстань до найближчого менше 1 стільця (тобто, поруч).
"""
